 ...
 * 
 * Usage: mvn compile exec:java -Dexec.mainClass="ai.mindvex.backend.util.CreateVectorEmbeddingsTable"
 */
public class CreateVectorEmbeddingsTable {
    ...
    public static void main(String[] args) {
        ...
        if (dbUrl == null || dbUrl.isEmpty()) {
            ...
            System.err.println("$env:DATABASE_URL = \"jdbc:postgresql://crossover.proxy.rlwy.net:47666/railway?user=postgres&password=YOUR_PASSWORD\"");
            System.exit(1);
        }
